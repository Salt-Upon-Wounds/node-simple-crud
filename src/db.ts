...
export const db = new Map<string, User>([
  [ids[0], { id: ids[0], username: 'test_user1', age: 1, hobbies: ['asd', 'qwe'] }],
  [ids[1], { id: ids[1], username: 'test_user2', age: 2, hobbies: ['zxc'] }],
  [ids[2], { id: ids[2], username: 'test_user3', age: 3, hobbies: [] }],
])
